function cal() {
    ...
    var res0; //레인지샷 대미지
    if (v15 > 100) {
        res0 = (v0 * (1 + 0.2 * v10) * (1 + (v5 / 100)) * (1 + 0.2 * v10)) * (0.01 * v15) * (1 + v7 / 100) * (1 + v12) * (1 + 0.5 * v17) * (1 + v3 * v20) * (1 * v00 + 2 * v00_1) * (1 + 1 * v11)
    } else if (v15 >= 70) {
        res0 = (v0 * (1 + 0.2 * v10) * (1 + (v5 / 100)) * (1 + 0.2 * v10)) * (0.01 * v15 + (0.5 * (1 - 0.01 * v15))) * (1 + v7 / 100) * (1 + 1 * v12) * (1 + 0.5 * v17) * (1 + v3 * v20) * (1 * v00 + 2 * v00_1) * (1 + 1 * v11)
    } else {
        res0 = (v0 * (1 + 0.2 * v10) * (1 + (v5 / 100)) * (1 + 0.2 * v10)) * (0.01 * v15) * (1 + v7 / 100) * (1 + 1 * v12) * (1 + 0.5 * v17) * (1 + v3 * v20) * (1 * v00 + 2 * v00_1) * (1 + 1 * v11)
    }
    ...
    if (v15 > 100) {
        res0_1 = ((v0 + 5 * v18) * (1 + 0.2 * v10) * (1 + (v5 / 100)) * (1 + 0.2 * v10)) * (0.01 * v15) * (1 + v7 / 100) * (1 + v12) * (1 + 0.5 * v17) * (1 + v3 * v20) * (1 * v00 + 0 * v00_1) * (1 + 1 * v11)
    } else if (v15 >= 70) {
        res0_1 = ((v0 + 5 * v18) * (1 + 0.2 * v10) * (1 + (v5 / 100)) * (1 + 0.2 * v10)) * (0.01 * v15 + (0.5 * (1 - 0.01 * v15))) * (1 + v7 / 100) * (1 + 1 * v12) * (1 + 0.5 * v17) * (1 + v3 * v20) * (1 * v00 + 0 * v00_1) * (1 + 1 * v11)
    } else {
        res0_1 = ((v0 + 5 * v18) * (1 + 0.2 * v10) * (1 + (v5 / 100)) * (1 + 0.2 * v10)) * (0.01 * v15) * (1 + v7 / 100) * (1 + 1 * v12) * (1 + 0.5 * v17) * (1 + v3 * v20) * (1 * v00 + 0 * v00_1) * (1 + 1 * v11)
    }
    ...
    var res3; //크래시샷 파편댐
    res3 = res0 * (1 * v00 + 0.5 * v00_1) * (1 * v2_1 + 0.04 * v19 + v9 / 100)
