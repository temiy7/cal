function cal() {
    ...
    res1 = (481 + 3.5 * v1 + 0.5 * v2 + 0.5 * v14 * (1 + 0.2 * v23) * (v13 / 100) + 5 * v3) * 3.5 * (1 + 0.15 + 0.005 * v6 + (v11 / 100) + 0.1 * v27 + 0.15 * v33) * (1 + (v24/100)  + 0.01 *  (1*v25+1*v35))
    ...
    res3 = (481 + 3.5 * v1 + 0.5 * v2 + 0.5 * v14 * (1 + 0.2 * v23) * (v13 / 100) + 5 * v3) * 6 * (1 + 0.15 + 0.005 * v6 + (v11 / 100) + 0.1 * v27 + 0.15 * v33) * (1 + (v24/100)  + 0.01 *  (1*v25+1*v35))
    ...
    res4 = (2760 + 0.85*21 * v1 + 0.85*0.5 * v2 + 0.85*0.5 * v14 * (1 + 0.2 * v23) * (v13 / 100) + 15 * v4) * (1 + 0.15 + 0.005 * v7 + (v15 / 100) + 0.1 * v26 + 0.15 * v33) * (1 + (v24/100)  + 0.01 *  (1*v25+1*v35))
    ...
    res5 = (336 + 2.3 * v1 + 0.1 * v2 + 0.1 * v14 * (1 + 0.2 * v23) * (v13 / 100) + 5 * v5) * 3 * (1 + 0.15 + 0.005 * v8 + 0.15 * v9 + (v12 / 100) + 0.1 * v28 + 0.15 * v33) * (1 + (v24/100)  + 0.01 *  (1*v25+1*v35))
    ...
    res6 = (336 + 2.3 * v1 + 0.1 * v2 + 0.1 * v14 * (1 + 0.2 * v23) * (v13 / 100) + 5 * v5) * 6.5 * (1 + 0.15 + 0.005 * v8 + 0.15 * v9 + (v12 / 100) + 0.1 * v28 + 0.15 * v33) * (1 + (v24/100)  + 0.01 *  (1*v25+1*v35))
    ...
    res16 = (425 + 0.85*3.23 * v1 + 0.85*0.077 * v2 + 0.85*0.077 * v14 * (v13 / 100) + 2.3 * v4) * 3 * (1 + 0.15 + 0.005 * v7 + (v15 / 100) + 0.1 * v26 + 0.15 * v33) * (1 + v24 / 100 + 1 + 0.01 * (1*v25+1*v35))
    ...
    res20 = v1 * 1.875 * 0.3525 * (14 + 0.1 * v29) * (2.4 + 0.05 * v30) * v32 * (1 + v31 / 100) * (1 + (v24/100)  + 0.01 *  (1*v25+1*v35))
