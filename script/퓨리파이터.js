function cal() {
    ...
    // ---- 기본 연속기 스킬 ----
    var res1 = res0 * (v2 + 0.03 * v23) * (1 + 0.3 * v19) * (1 + v11 / 100); //대펀
    var res2 = res0 * (v3 + 0.06 * v24) * (1 + 0.2 * v20) * (1 + v12 / 100); //어퍼
    var res3 = res0 * (v4 + 0.09 * v25) * (1 + v18_1) * (1 + 0.1 * v21) * (1 + v13 / 100); //드롭
    var res4 = res0 * (v5 + 0.03 * v31) * (1 + v14 / 100); //차피
    var res5 = res0 * (v6 + 0.06 * v26) * (1 + v15 / 100); //섬솔
    var res6 = res0 * (v7 + 0.09 * v27 + v18_2) * (1 + v16 / 100); //파운딩
