function cal() {
    ...
    var res4; //라스매 엘-인
    res4 = (v4*(1+0.2*v11)*(1+(v5/100)*(1+0.2*v11)))*((1*v1+0.1*v18)*(1+0.15*v15)*(1+0.2*v17)*(1+1*v22)+1*v1_0+1*v12*v1_01)*(1+v7/100)
    ...
    var res4_1; //라스매 자이언트
    res4_1 = (v4*(1+0.2*v11)*(1+(v5/100)*(1+0.2*v11)))*((1*v1_1+0.1*v18)*(1+0.15*v15)*(1+0.2*v17)*(1+1*v22)+1*v1_0+1*v12*v1_01)*(1+v7/100)
    ...
    var res5; //아윈밀 인-자
    res5 =(v4*(1+0.2*v11)*(1+(v5/100)*(1+0.2*v11)))*((1*v2+0.03*v19)*(1+0.3*v16)*(1+1*v22_1)+1*v2_0)*(1+v7/100)
    ...
    var res5_1; //아윈밀 엘프
    res5_1 =(v4*(1+0.2*v11)*(1+(v5/100)*(1+0.2*v11)))*((1*v2_1+0.03*v19)*(1+0.3*v16)*(1+0.15*v22_1)+1*v2_0)*(1+v7/100)
