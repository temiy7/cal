function cal() {
    ...
    var res1; //런지
    res1 = ((6000 + v1 * 100) * (1 + 0.15 + 0.005 * v15 + 0.15 * v28)* (1 + (v29+v29_3 )/ 100) + ((2760 + 0.85*21 * v1 + 0.85*0.5 * v2 + 15 * v7) * (1 + 0.15 + 0.005 * v15 + 0.1 * v33 + 0.15 * v28)) * (1 + (v29+v29_1+v29_2+v29_3 )/100 + (1*v34 +1*v30_1))) * v30 * v4;
    ...
    var res3; //스톰
    res3 = ((1000 + v1 * 17) * (1 + 0.15 + 0.005 * v16 + 0.15 * v28+0.15*v27)* (1 + (v29+v29_3 )/ 100) + ((336 + 2.3 * v1 + 0.1 * v2 + 5 * v8) * (1 + 0.15 + 0.005 * v16 + 0.15 * v27 + 0.1 * v33 + 0.15 * v28) * v30_1* (1 + (v29+v29_1+v29_2+v29_3 )/ 100))) * v30 ;
