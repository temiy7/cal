function cal() {
    ...
    var res1; //런지
    res1 = ((6000 + v1 * 100) * (1 + 0.15 + 0.005 * v15 + 0.15 * v28)* (1 + (v29+v29_3 )/ 100) + ((2760 + 21 * v1 + 0.5 * v2 + 15 * v7) * (1 + 0.15 + 0.005 * v15 + 0.1 * v33 + 0.15 * v28)) * (1 + (v29+v29_1+v29_2+v29_3 )/ 100)  * v30_1) * v30 * v4;
