function cal() {
    ...
    var res1; //런지
    res1 = ((6000 + v1 * 100) * (1 + 0.15 + 0.005 * v15 + 0.15 * v28) + ((2760 + 21 * v1 + 0.5 * v2 + 15 * v7) * (1 + 0.15 + 0.005 * v15 + 0.1 * v33 + 0.15 * v28)) * v30_1) * v30 * (1 + (v29+v29_1+v29_2+v29_3 )/ 100) * v4;
    ...
    var res2; //체인
    res2 = ((800 + v1 * 11) * (1 + 0.15 + 0.005 * v14 + 0.15 * v28) + ((180 + 0.6 * v1 + 0.44 * v2 + 2.5 * v3 + (7 + 0.75 * v31) * v30_2) *1.1* (1 + 1.5 + 0.3 + 0.01 * v12 + 0.005 * v14 +  0.15 * v28 +0.1*v33))) * v30 * (1 + (v29+v29_1+v29_2+v29_3 )/ 100);
    ...
    var res3; //스톰
    res3 = ((1000 + v1 * 17) * (1 + 0.15 + 0.005 * v16 + 0.15 * v28+0.15*v27) + ((336 + 2.3 * v1 + 0.1 * v2 + 5 * v8) * (1 + 0.15 + 0.005 * v16 + 0.15 * v27 + 0.1 * v33 + 0.15 * v28) * v30_1)) * v30 * (1 + (v29+v29_1+v29_2+v29_3 )/ 100);
