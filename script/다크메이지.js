function cal() {
    ...
    var v4 = $('input[name="v4"]').is(':checked') ? parseFloat($('input[name="v4"]').val()) : 1; //라체상채
    ...
    //아이템 타이틀
    var v26 = $('input[name="v26"]').is(':checked') ? parseFloat($('input[name="v26"]').val()) : 0; // 헤보나로브
    ...
    var v33 = $('input[name="v33"]').is(':checked') ? parseFloat($('input[name="v33"]').val()) : 0; //로즈마리장갑


    //계산식

    var res1; //런지
    res1 = ((6000 + v1 * 100) * (1 + 0.15 + 0.005 * v15 + 0.15 * v28) + ((2760 + 21 * v1 + 0.5 * v2 + 15 * v7) * (1 + 0.15 + 0.005 * v15 + 0.1 * v33 + 0.15 * v28)) * v30_1) * v30 * (1 + v29 / 100) * v4;
    ...
    var res2; //체인
    res2 = ((800 + v1 * 11) * (1 + 0.15 + 0.005 * v14 + 0.15 * v28) + ((180 + 0.6 * v1 + 0.44 * v2 + 2.5 * v3 + (7 + 0.75 * v31) * 5 * v30_2) * 1.28 * (1 + 1.5 + 0.3 + 0.01 * v12 + 0.005 * v14 + 0.1 * v33 + 0.15 * v26 + 0.15 * v28))) * v30 * (1 + v29 / 100);
    ...
    var res3; //스톰
    res3 = ((1000 + v1 * 17) * (1 + 0.15 + 0.005 * v16 + 0.15 * v28+0.15*v27) + ((336 + 2.3 * v1 + 0.1 * v2 + 5 * v8) * (1 + 0.15 + 0.005 * v16 + 0.15 * v27 + 0.1 * v33 + 0.15 * v28) * v30_1)) * v30 * (1 + v29 / 100);
