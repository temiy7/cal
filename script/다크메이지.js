...
function cal() {
    ...
    var res2; //체인
    res2 = ((800+v1*11)*(1+0.15+0.05*v14+0.15*v28)*v30 +((180 + 0.6 * v1 + 0.44 * v2 + 2.5 * v3 + (7 + 0.75 * v31)*5*v30_2) *1.28 * (1 + 1.5 + 0.3 + 0.01 * v12 + 0.005 * v14+0.1*v33+0.15*v26 ))) * (1 + v29 / 100);
    ...
    var res3; //스톰
    res3 = ((1000+v1*17)*(1+0.15+0.05*v16+0.15*v28)*v30 +((336 + 2.3 * v1 + 0.1 * v2 + 5 * v8) * (1 + 0.15 + 0.005 * v16 + 0.15 * v27 +0.1*v33) *v30_1 )) * (1 + v29 / 100);
